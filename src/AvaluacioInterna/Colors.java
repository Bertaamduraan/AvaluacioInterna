...
public class Colors {
    ...
    void setColors(PApplet p5){
        ...
        this.colors[0] = p5.color(0xFF611633);
        this.colors[1] = p5.color(0xFFF1DAB1);
        this.colors[2] = p5.color(0xFF19381F);
        this.colors[3] = p5.color(0xFF53A548);
        this.colors[4] = p5.color(0xFF4C934C);
        this.colors[5] = p5.color(0xFFAEECEF);
        //COLORES BOTONES
